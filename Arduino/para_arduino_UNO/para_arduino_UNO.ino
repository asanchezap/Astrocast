/*
  ...
  Arduino compatibility checked: Arduino UNO
...
#define tx 3
#define ev 4
SoftwareSerial ASTRONODE_SERIAL (rx, tx);
...
void setup(){
  ...
  attachInterrupt(digitalPinToInterrupt(ev), inter, RISING);
  digitalWrite(13, LOW);
}
